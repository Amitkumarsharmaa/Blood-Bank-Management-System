...
<body>
<p style="text-align:center;font-size:60px;font-family:cursive;color:red;text-decoration:underline;border-radius:0.5px">BBMS</p>
 <?php 
...
?>
	...
	<footer class="footer-distributed">
                ...
                <h3 style="color:black;font-size: 20px">&copy 2023 BBMS</h3>
